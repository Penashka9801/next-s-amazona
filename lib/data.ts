...
const products: IProductInput[] = [
  ...
  {
    name: 'Стул для мытья',
    slug: toSlug('tovar dlya mytya'),
    category: 'T-Shirts',
    images: ['/images/p-stul.jpg' , ],
    tags: ['new-arrival'],
    isPublished: true,
    price: 21.8,
    listPrice: 0,
  ...
  {
    name: 'Otyrgych',
    slug: toSlug('Otyrgych'),
    category: 'Stol-stul',
    images: ['/images/stol-stul.jpg', ],
    tags: ['new-arrival'],
    isPublished: true,
    price: 21.8,
    listPrice: 0,
  ...
  settings: [
    {
      ...
      site: {
        ...
        url: 'https://akyolexpress.vercel.app/',
        logo: '/icons/logo.svg',
        slogan: 'Spend less, enjoy more.',
        author: 'Next Ecommerce',
        copyright: '2025, akyolexpress.com',
        email: 'admin@example.com',
        address: 'Nurmuhammed Andalyp, 45343',
        phone: '9936599999999',
      },
      carousels: [
        {
